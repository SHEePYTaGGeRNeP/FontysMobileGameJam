...
public class HubGui : MonoBehaviour
{
    ...
    void OnGUI()
    {
        ...
        GUILayout.Space(10);
        this.scrollPos = GUILayout.BeginScrollView(this.scrollPos, GUILayout.Width(320));

        GUILayout.Label("Basics", this.m_Headline);
        if (GUILayout.Button("Demo Boxes", GUILayout.Width(280)))
        {
            ...
            this.demoBtn = new DemoBtn() { Text = "Start", Link = "DemoBoxes-Scene" };
        }
        if (GUILayout.Button("Demo Worker", GUILayout.Width(280)))
        {
            ...
            this.demoBtn = new DemoBtn() { Text = "Start", Link = "DemoWorker-Scene" };
        }
        if (GUILayout.Button("Movement Smoothing", GUILayout.Width(280)))
        {
            ...
            this.demoBtn = new DemoBtn() { Text = "Start", Link = "DemoSynchronization-Scene" };
        }

        GUILayout.Label("Advanced", this.m_Headline);
        ...
        GUILayout.Label("Feature Demos", this.m_Headline);
        ...
        GUILayout.Label("Tutorial", this.m_Headline);
        ...
        GUILayout.Label(this.demoDescription);
        GUILayout.Space(10);
