...
public class PickupController : MonoBehaviour, IPunObservable
{
    ...
    void Awake()
    {
        ...
        if (pv != null)
        {
            ...
            if (pv.observed is Transform && !this.DoRotate)
            {
    ...
    {        
        ...
        {
            this.transform.position = Vector3.Lerp(this.transform.position, this.remotePosition, Time.deltaTime * this.RemoteSmoothing);
        }

        this.velocity = (this.transform.position - this.lastPos)*25;
    ...
    public void OnPhotonSerializeView(PhotonStream stream, PhotonMessageInfo info)
    {
        ...
        else
        {
            ...
            if (initialRemotePosition)
            {
                ...
                this.transform.position = this.remotePosition;
            }
        }
    }
